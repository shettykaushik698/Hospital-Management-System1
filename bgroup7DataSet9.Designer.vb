...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("bgroup7DataSet9"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class bgroup7DataSet9
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As bgroup7DataSet9 = CType(MyBase.Clone,bgroup7DataSet9)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "bgroup7DataSet9"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/bgroup7DataSet9.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As bgroup7DataSet9 = New bgroup7DataSet9
    ...
    Partial Public Class blabDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddblabRow(ByVal sn As Decimal, ByVal tname As String, ByVal nrange As String) As blabRow
            Dim rowblabRow As blabRow = CType(Me.NewRow,blabRow)
            Dim columnValuesArray() As Object = New Object() {sn, tname, nrange}
...
Namespace bgroup7DataSet9TableAdapters
    ...
    Partial Public Class blabTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[blab] WHERE (((@IsNull_sn = 1 AND [sn] IS NULL) OR ([sn] = @Or"& _ 
                ...
                "] IS NULL) OR ([nrange] = @Original_nrange)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[blab] ([sn], [tname], [nrange]) VALUES (@sn, @tname, @nrange);"& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT sn, tname, nrange FROM blab WHERE (tname = @tname)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[blab] SET [sn] = @sn, [tname] = @tname, [nrange] = @nrange WHERE (("& _ 
                "(@IsNull_sn = 1 AND [sn] IS NULL) OR ([sn] = @Original_sn)) AND ([tname] = @Orig"& _ 
                "inal_tname) AND ((@IsNull_nrange = 1 AND [nrange] IS NULL) OR ([nrange] = @Origi"& _ 
                "nal_nrange)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT sn, tname, nrange FROM blab WHERE (tname = @tname)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT sn, tname, nrange FROM dbo.blab"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As bgroup7DataSet9.blabDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As bgroup7DataSet9.blabDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As bgroup7DataSet9.blabDataTable = New bgroup7DataSet9.blabDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As bgroup7DataSet9.blabDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As bgroup7DataSet9) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_sn As Global.System.Nullable(Of Decimal), ByVal Original_tname As String, ByVal Original_nrange As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal sn As Global.System.Nullable(Of Decimal), ByVal tname As String, ByVal nrange As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal sn As Global.System.Nullable(Of Decimal), ByVal tname As String, ByVal nrange As String, ByVal Original_sn As Global.System.Nullable(Of Decimal), ByVal Original_tname As String, ByVal Original_nrange As String) As Integer
            If (sn.HasValue = true) Then
            ...
            If (Original_sn.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_sn.Value,Decimal)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_nrange,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal sn As Global.System.Nullable(Of Decimal), ByVal nrange As String, ByVal Original_sn As Global.System.Nullable(Of Decimal), ByVal Original_tname As String, ByVal Original_nrange As String) As Integer
            Return Me.Update(sn, Original_tname, nrange, Original_sn, Original_tname, Original_nrange)
        End Function
    End Class
End Namespace
